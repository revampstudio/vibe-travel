  ...
  return (
    <AnimatePresence mode="wait">
      {expanded ? (
        ...
        >
          {/* Top padding to clear logo + settings gear */}
        ...
        <motion.button
          key="pill"
          className="absolute top-1/2 -translate-y-1/2 left-3 z-20 flex items-center gap-2 rounded-full
                     bg-white/95 backdrop-blur-md border border-border/60 shadow-lg
                     pl-3 pr-2.5 py-2 cursor-pointer hover:bg-white transition-colors"
        ...
        >
          ...
          <span className="text-xs font-semibold text-text whitespace-nowrap">
            {ranked.length} picks for you
          </span>
          <svg className="size-3.5 text-muted flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
